  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* <div className="bg-primary font-bold text-[45px] md:text-[50px] lg:text-[30px] text-white font-poppins">
          STB&nbsp;<span className="text-[#915eff]">AMU</span>
        </div> */}
      </Link>
      ...
      <motion.div>
        ...
        <Pop toggle={toggle} setToggle={setToggle} />
      </motion.div>
    </motion.div>
  );
};
